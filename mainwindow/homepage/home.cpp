...
PageHome::PageHome(QWidget* parent) : QWidget(parent) {
  ...
  QString strings = "<html><body>"
                   "<h3>Selamat Datang di Aplikasi "
                   "Sistem Informasi Akademik</h3>"
                   "<br/><b>Mengenai aplikasi</b><br/>"
                   "<p>Aplikasi sistem informasi akademik adalah "
                   "aplikasi yang ditunjukkan untuk membantu sekolah "
                   "dalam mengolah data-data akademik secara "
                   "cepat dan mudah.</p>"
                   "<p><b>Fitur</b></p>"
                   "<p>Dengan aplikasi SIA, pihak sekolah dapat "
                   "melakukan berbagai hal seperti:</p>"
                   "<ul>"
                   ...
                   "</body></html>";
  QLabel* label = new QLabel(strings);
